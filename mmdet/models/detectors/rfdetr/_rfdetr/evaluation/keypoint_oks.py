...
from mmdet.models.detectors.rfdetr._rfdetr.evaluation.coco_eval import CocoEvaluator
...
class MetricKeypointOKS:
    ...
    def compute(self) -> dict[str, float]:
        ...
        Examples:
            ...
            ... }
            >>> with patch("mmdet.models.detectors.rfdetr._rfdetr.evaluation.keypoint_oks.CocoEvaluator", return_value=fake_eval):
            ...     metric.update({1: {}})
