...
from mmdet.models.detectors.rfdetr._rfdetr.datasets import build_dataset
from mmdet.models.detectors.rfdetr._rfdetr.datasets.aug_configs import AUG_CONFIG
from mmdet.models.detectors.rfdetr._rfdetr.utilities.box_ops import box_xyxy_to_cxcywh
from mmdet.models.detectors.rfdetr._rfdetr.utilities.logger import get_logger
from mmdet.models.detectors.rfdetr._rfdetr.utilities.tensors import make_collate_fn
...
def _has_cuda_device() -> bool:
    ...
    """
    from mmdet.models.detectors.rfdetr._rfdetr.config import DEVICE
...
class RFDETRDataModule(LightningDataModule):
    ...
    def _show_samples(
        ...
        *,
        ...
        from mmdet.models.detectors.rfdetr._rfdetr.utilities.box_ops import box_cxcywh_to_xyxy
    ...
    def _setup_kornia_pipeline(self) -> None:
        ...
        from mmdet.models.detectors.rfdetr._rfdetr.datasets.kornia_transforms import build_kornia_pipeline, build_normalize
    ...
    def on_after_batch_transfer(self, batch: tuple, dataloader_idx: int) -> tuple:
        ...
        from mmdet.models.detectors.rfdetr._rfdetr.datasets.kornia_transforms import collate_boxes, collate_masks, unpack_boxes
        from mmdet.models.detectors.rfdetr._rfdetr.utilities.tensors import NestedTensor
