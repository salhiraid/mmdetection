...
from mmdet.models.detectors.rfdetr._rfdetr.training.callbacks.ema import RFDETREMACallback
from mmdet.models.detectors.rfdetr._rfdetr.utilities.logger import get_logger
from mmdet.models.detectors.rfdetr._rfdetr.utilities.package import get_version
from mmdet.models.detectors.rfdetr._rfdetr.utilities.state_dict import _make_fit_loop_state, strip_checkpoint
...
class BestModelCallback(ModelCheckpoint):
    ...
    Examples:
        ...
        >>> import tempfile
        >>> from mmdet.models.detectors.rfdetr._rfdetr.training.callbacks.best_model import BestModelCallback
...
class RFDETREarlyStopping(EarlyStopping):
    ...
    Examples:
        ...
        >>> from mmdet.models.detectors.rfdetr._rfdetr.training.callbacks.best_model import RFDETREarlyStopping
