...
from mmdet.models.detectors.rfdetr._rfdetr.utilities.files import _download_file, _validate_file_md5
...
class ModelWeightsBase(Enum):
    ...
    Example inheritance:
        >>> from mmdet.models.detectors.rfdetr._rfdetr.assets import ModelWeightAsset
    ...
    Example usage:
        >>> from mmdet.models.detectors.rfdetr._rfdetr.assets.model_weights import ModelWeights
...
def download_pretrain_weights(
    ...
    if asset is not None:
        ...
        try:
            from mmdet.models.detectors.rfdetr._rfdetr.platform.downloads import PLATFORM_MODELS
