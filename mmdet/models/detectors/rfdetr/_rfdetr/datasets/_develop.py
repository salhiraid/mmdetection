...
from mmdet.models.detectors.rfdetr._rfdetr.util.logger import get_logger
...
class _SimpleDataset:
    ...
    Examples:
        ...
        >>> from mmdet.models.detectors.rfdetr._rfdetr.datasets.transforms import AlbumentationsWrapper
        >>>
        >>> transforms = Compose([
