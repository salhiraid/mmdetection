...
Usage::
    ...
    from mmdet.models.detectors.rfdetr._rfdetr.datasets.kornia_transforms import (
...
from mmdet.models.detectors.rfdetr._rfdetr.datasets._aug_utils import filter_keypoint_hflip_augmentations
...
def build_kornia_pipeline(
    ...
    Examples:
        >>> from mmdet.models.detectors.rfdetr._rfdetr.datasets.aug_configs import AUG_CONSERVATIVE
