...
Usage::
    ...
    from mmdet.models.detectors.rfdetr._rfdetr.visualize.training import plot_metrics
...
def plot_loss_metrics(
    ...
    Examples:
        .. code-block:: python
            ...
            from mmdet.models.detectors.rfdetr._rfdetr.visualize.training import plot_loss_metrics
...
def plot_map_metrics(
    ...
    Examples:
        .. code-block:: python
            ...
            from mmdet.models.detectors.rfdetr._rfdetr.visualize.training import plot_map_metrics
