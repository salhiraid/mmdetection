...
hint) instead of the cryptic default ``ModuleNotFoundError: No module named 'mmdet.models.detectors.rfdetr._rfdetr.util'``.
...
from mmdet.models.detectors.rfdetr._rfdetr.detr import RFDETR
from mmdet.models.detectors.rfdetr._rfdetr.inference import ModelContext
from mmdet.models.detectors.rfdetr._rfdetr.variants import (
...
_REMOVE_IN_VERSION_1_9 = {
    "util": "mmdet.models.detectors.rfdetr._rfdetr.util will be removed in v1.9.0. Use rfdetr.utilities instead.",
    "deploy": "mmdet.models.detectors.rfdetr._rfdetr.deploy will be removed in v1.9.0. Use rfdetr.export instead.",
}
...
def __getattr__(name: str):
    ...
    * Removed-module aliases (keys in ``_REMOVE_IN_VERSION_1_9``, such as ``util`` and ``deploy``)
    ...
    if name in _LAZY_TRAINING:
        from mmdet.models.detectors.rfdetr._rfdetr import training as _training
    ...
    if name in _PLUS_EXPORTS:
        ...
        from mmdet.models.detectors.rfdetr._rfdetr.platform import models as _platform_models
