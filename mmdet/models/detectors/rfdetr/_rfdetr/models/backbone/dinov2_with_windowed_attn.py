...
class WindowedDinov2WithRegistersConfig(BackboneConfigMixin, PretrainedConfig):
    ...
    >>> from mmdet.models.detectors.rfdetr._rfdetr.models.backbone.dinov2_with_windowed_attn import WindowedDinov2WithRegistersConfig
...
class WindowedDinov2WithRegistersModel(WindowedDinov2WithRegistersPreTrainedModel):
    ...
    def set_attn_implementation(self, attn_implementation: str) -> None:
        ...
        Example::
            ...
            >>> from mmdet.models.detectors.rfdetr._rfdetr.models.backbone.dinov2_with_windowed_attn import (
